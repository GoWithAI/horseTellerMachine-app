1. Test cases can be written for Each service
2. sonar coverage we can be do also
3. Designwise we can support differrent design approaches based on Future of scope of application and how it evolve  and refactoring
